for var in GPP GPP_SD; do
    ...
    cdo -b F64 -L -divc,1e+15 -yearsum -settaxis,2001-01-01,00:00,1month \
        -seldate,2001-07-16,2017-06-16 -sellonlatbox,112.25,153.75,-43.75,-10.25 \
        -mul TRENDY_comparison/GOSIF_$var'_'australia.nc -gridarea \
        TRENDY_comparison/GOSIF_$var'_'australia.nc \
